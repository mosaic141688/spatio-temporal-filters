...
const feature_in_box = function (feature, box_feature) {
    return feature.lat > box_feature.box[0].lat && feature.lat < box_feature.box[1].lat && feature.lng > box_feature.box[0].lng && feature.lng < box_feature.box[2].lng;
};
...
ava.test('filter by district', t => {
    ...
    console.log(decorated_record_points);
    //Filter 
    let filtered_record_points = decorated_record_points.filter(point => point[decoration] == filter_id);
});
//# sourceMappingURL=../node_modules/.cache/ava/eff5d94cff3b1ae4087c8dd0ffd88e6c.js.map